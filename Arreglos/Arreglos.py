...
newlista=sorted(lista, key=, reverse=) #A diferencia de sort, esta retorna una nueva lista, la anterior la modifica. Toman los mismo parámetros.
...
dic4= dict.fromkeys(lista) #Un segundo parámetro define el valor de cada llave. Por defecto es None. Esta monda solo sirve para usar +1 en las claves.
...
dic.update(dic2) #Actualiza con nuevos datos ó dic | dic2
